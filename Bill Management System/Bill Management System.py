...
def Total():
    ...
    string_bill="Dh",str("%.2f" %totalcost)
    Total_bill.set(string_bill)

Label(text="BILL MANAGEMENT App",bg="black",fg="white",font=("calibri",33),width="300",height="2").pack()
#Menu Card
...
Label(f,font=("Lucida Calligraphy",15,'bold'),text="Tajine ......... 30dh/tajine",fg="black",bg="lightgreen").place(x=10,y=80)
Label(f,font=("Lucida Calligraphy",15,'bold'),text="jus d'orange .......12dh/cup",fg="black",bg="lightgreen").place(x=10,y=110)
Label(f,font=("Lucida Calligraphy",15,'bold'),text="Tee bena3na3 ......... 7dh/cup",fg="black",bg="lightgreen").place(x=10,y=140)
Label(f,font=("Lucida Calligraphy",15,'bold'),text="Caffe noir ......... 6dh/cup",fg="black",bg="lightgreen").place(x=10,y=170)
Label(f,font=("Lucida Calligraphy",15,'bold'),text="Juice ......... 15dh/glass",fg="black",bg="lightgreen").place(x=10,y=200)
Label(f,font=("Lucida Calligraphy",15,'bold'),text="sardine......... 15dh/chouwaya",fg="black",bg="lightgreen").place(x=10,y=230)
Label(f,font=("Lucida Calligraphy",15,'bold'),text="Eggs ......... 7dh/egg",fg="black",bg="lightgreen").place(x=10,y=260)
...
#Label
lbl_dosa=Label(f1,font=("aria",20,'bold'),text="Tajine",width=12,fg="blue4")
lbl_cookies=Label(f1,font=("aria",20,'bold'),text="jus d'orange",width=12,fg="blue4")
lbl_Tea=Label(f1,font=("aria",20,'bold'),text="Tee bena3na3",width=12,fg="blue4")
lbl_cofee=Label(f1,font=("aria",20,'bold'),text="Caffe noir",width=12,fg="blue4")
lbl_juice=Label(f1,font=("aria",20,'bold'),text="juice",width=12,fg="blue4")
lbl_pancakes=Label(f1,font=("aria",20,'bold'),text="sardine",width=12,fg="blue4")
...
btn_reset=Button(f1,bd=5,fg="lightblue",font=("ariel",16,"bold"),width=10,text="Reset",command=reset)
